      ...
      <div className="w-96 h-[900px] relative bg-[#FFF4BB] overflow-auto pt-20">
        ...
        <div className="px-4 mb-4">
          <div className="p-4 bg-white rounded-xl shadow-sm">
            ...
            {/* 지역 필터 */}
            <div className="mb-2">
              <div className="text-sm font-['Do_Hyeon'] mb-1 text-gray-700">
                지역
              </div>
            ...
            <div className="relative bg-[#FFF4F4] rounded-3xl shadow-lg p-6 w-[370px] max-h-[80vh] overflow-y-auto border-4 border-purple-200">
              ...
              <div className="text-left text-sm font-['Do_Hyeon'] text-gray-700 space-y-3">
                <div>
                  ...
                  <br />
                  한부모가족복지시설은 한부모가족이 건강하고 문화적인 생활을
                  영위할 수 있도록 제공하는 다양한 복지시설입니다.
                </div>
                <div>
                  <span className="font-bold text-purple-600">시설 유형</span>
                  <ul className="list-disc ml-4 mt-1">
                    <li>
                      <b>출산지원시설</b>: 미혼모의 임신과 출산, 양육을 지원
                    </li>
                    <li>
                      <b>양육지원시설</b>: 한부모가 유아·아동의 양육 어려움을
                      해소하고 자립 지원
                    </li>
                    <li>
                      <b>생활지원시설</b>: 한부모와 그 자녀가 함께 일정 기간
                      생활하면서 자립 준비
                    </li>
                    <li>
                      <b>일시지원복지시설</b>: 한부모가 일시적으로 보호와 숙식
                      제공이 필요한 경우 지원
                    </li>
                    <li>
                      <b>한부모가족복지상담소</b>: 한부모가족에 대한 상담 및
                      정보 제공
                    </li>
                  </ul>
                </div>
                <div>
                  <span className="font-bold text-purple-600">지원 내용</span>
                  <br />
                  <ul className="list-disc ml-4 mt-1">
                    <li>주거 및 숙식 제공</li>
                ...
                <div>
                  <span className="font-bold text-purple-600">이용 방법</span>
                  <br />
                  가까운 시·군·구청 한부모가족 담당부서, 관할 읍·면·동
                  주민센터를 통해 신청하거나 해당 시설에 직접 문의
                </div>
              </div>
              <button
                onClick={() => setShowInfoPopup(false)}
