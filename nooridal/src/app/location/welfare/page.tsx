          ...
          <>
            ...
            {showParentalInfo && (
              <div className="fixed inset-0 flex items-center justify-center z-40">
                <div className="absolute inset-0 bg-black/50" onClick={() => setShowParentalInfo(false)} />
                <div className="relative bg-[#FFF4F4] rounded-3xl shadow-lg p-6 w-[370px] max-h-[80vh] overflow-y-auto border-4 border-pink-200">
                  ...
                  <div className="text-left text-sm font-['Do_Hyeon'] text-gray-700 space-y-3">
                    <div>
                      <span className="font-bold text-pink-600">육아휴직제도</span><br/>
                      근로자가 피고용자의 신분을 유지하면서, 일정기간 자녀의 양육을 위해 휴직을 할 수 있도록 하는 제도입니다.
                    </div>
                    <div>
                      <span className="font-bold text-pink-600">육아휴직 대상</span><br/>
                      사업주는 <br />①임신 중인 여성 근로자가 모성을 보호하거나 <br />②근로자가 만 8세 이하 또는 초등학교 2학년 이하의 자녀(입양한 자녀 포함)를 양육하기 위해 휴직(이하 '육아휴직'이라 함)을 신청하는 경우에 이를 허용해야 합니다.<br/>
                      <span className="text-[10px] text-gray-500">(남녀고용평등과 일·가정 양립 지원에 관한 법률 제19조제1항 본문)</span>
                    </div>
                    <div>
                      <span className="font-bold text-pink-600">육아휴직의 신청</span>
                      <ul className="list-disc ml-4 mt-1">
                        <li>휴직개시예정일의 30일 전까지 신청서 제출</li>
                        <li>신청서에 인적사항, 자녀 정보, 휴직기간 등 기재</li>
                        <li>특정 사유(유산, 사산, 조기출산 등)는 7일 전까지 신청 가능</li>
                      </ul>
                    </div>
                    <div>
                      <span className="font-bold text-pink-600">육아휴직의 기간 및 분할 사용</span><br/>
                      육아휴직의 기간은 1년 이내(특정 조건 시 6개월 추가 가능), 3회까지 분할 사용 가능
                    </div>
                    <div>
                      <span className="font-bold text-pink-600">육아휴직 후 불리한 처우 금지</span><br/>
                      사업주는 육아휴직을 이유로 해고나 불리한 처우를 해서는 안 됩니다.
                    </div>
                    <div>
                      <span className="font-bold text-pink-600">육아휴직 후 복직</span><br/>
                      복직 시 휴직 전과 같은 업무 또는 같은 수준의 임금 지급
                    </div>
                    <div>
                      <span className="font-bold text-pink-600">육아휴직 급여</span>
                      <ul className="list-disc ml-4 mt-1">
                        <li>육아휴직 1~3개월: 월 통상임금(최대 250만원, 최소 70만원)</li>
                        <li>4~6개월: 월 통상임금(최대 200만원, 최소 70만원)</li>
                        <li>7개월~종료: 월 통상임금의 80%(최대 160만원, 최소 70만원)</li>
                        <li>부모 동시 육아휴직 등 특례는 별도 규정 적용</li>
                      </ul>
                    </div>
                    <div>
                      <span className="font-bold text-pink-600">급여의 감액 및 지급제한</span><br/>
                      육아휴직 중 이직, 취업, 부정수급 등은 급여 지급이 제한될 수 있습니다.
                    </div>
                  </div>
                  <div className="flex justify-center mt-6">
                    <button
                ...
                <div className="relative bg-[#F4F8FF] rounded-3xl shadow-lg p-6 w-[370px] max-h-[80vh] overflow-y-auto border-4 border-blue-200">
                  <div className="flex flex-col items-center mb-2">
                    <div className="text-xl font-['Do_Hyeon'] text-blue-600 mb-2 flex items-center">
                      <span className="mr-2">💼</span> 경력단절 예방/재취업/지원센터 안내
                    </div>
                  </div>
                  <div className="text-left text-sm font-['Do_Hyeon'] text-gray-700 space-y-3">
                    <div>
                      <span className="font-bold text-blue-600">여성근로자의 경력단절 예방을 위한 정책지원</span><br/>
                      여성가족부장관과 고용노동부장관은 여성의 경제활동 촉진과 경력단절을 예방하기 위하여 다음의 기관이 생애주기별 여성경력설계 및 개발 상담 등을 실시할 수 있도록 지원할 수 있습니다.<br/>
                      <ul className="list-disc ml-4 mt-1">
                        <li>여성인력개발센터</li>
                        <li>여성경제활동지원센터</li>
                    ...
                    <div>
                      <span className="font-bold text-blue-600">경력단절여성의 재취업지원</span><br/>
                      <span className="font-semibold">직업교육훈련</span><br/>
                      여성가족부장관은 경력단절여성등의 경제활동을 촉진하기 위하여 여성인력개발기관 등의 기관에 여성에 대한 직업교육훈련을 실시하도록 지원할 수 있습니다.<br/>
                      지방자치단체의 장은 지역 특성에 맞는 직업교육훈련을 실시할 수 있으며, 여성가족부장관과 고용노동부장관은 이에 필요한 지원을 할 수 있습니다.
                    </div>
                    <div>
                      <span className="font-semibold">인턴취업지원</span><br/>
                      여성가족부장관은 경력단절여성등의 직업적응을 위하여 기업 등을 대상으로 인턴취업지원사업을 실시할 수 있습니다.<br/>
                      지방자치단체가 실시하는 일경험 지원 사업 및 취업연계 시책도 마련·지원할 수 있습니다.
                    </div>
                    <div>
                      <span className="font-bold text-blue-600">여성경제활동지원센터의 지정 및 운영</span><br/>
                      <span className="font-semibold">여성경제활동지원센터(여성새로일하기센터)</span><br/>
                      여성가족부장관과 고용노동부장관은 여성의 경력단절 예방과 경제활동 촉진에 필요한 사업을 수행하기 위하여 각 지역에 여성경제활동지원센터를 지정·운영할 수 있습니다.<br/>
                      <ul className="list-disc ml-4 mt-1">
                        <li>혼인·임신·출산과 휴직 후 복귀 등에 관한 상담, 정보제공 및 경력관리</li>
                        <li>생애주기별 경력개발교육, 멘토링 및 네트워크 형성 등 경력단절 예방 프로그램 지원</li>
                        <li>취업·창업 정보 제공 및 상담</li>
                        <li>직업교육훈련, 취업알선 및 취업 후 직장적응 지원</li>
                        <li>보육 지원 등 복지서비스 제공 및 연계</li>
                        <li>여성의 경제활동 촉진과 경력단절 예방을 위한 관련 기관, 기업과의 지역단위 네트워크 구축·운영</li>
                        <li>그 밖에 여성의 경제활동 촉진과 경력단절 예방을 위하여 필요한 사업</li>
                      </ul>
                    </div>
                    <div>
                      <span className="font-semibold">여성가족부장관과 고용노동부장관은 여성의 경력단절 예방과 경제활동 촉진에 관한 정책 및 지원센터의 사업을 효율적이고 체계적으로 지원하기 위하여 다음의 업무를 수행하는 중앙여성경제활동지원센터(이하 "중앙지원센터"라 한다)를 지정·운영할 수 있습니다(「여성의 경제활동 촉진과 경력단절 예방법」 제16조제1항 및 제2항).</span>
                      
                      <ul className="list-disc ml-4 mt-1">
                        <li>경력단절 예방에 관한 상담, 교육 등 사업 프로그램의 개발·보급</li>
                        <li>사회적·문화적 인식 개선 및 홍보 사업</li>
                        <li>취업·창업지원 등의 상담, 교육 등 사업 프로그램의 개발·보급</li>
                        <li>경력단절여성등의 직장 조기 적응 프로그램 개발·보급</li>
                    ...
                    <div className="mt-2 text-xs text-blue-700 bg-blue-50 rounded p-2">
                      여성새로일하기센터는 혼인·임신·출산·육아 등으로 경력이 단절된 여성 등에게 취업 상담, 직업교육훈련, 인턴십 및 취업 후 사후관리 등 종합적인 취업서비스를 지원하는 기관으로 고용노동부와 여성가족부가 공동주관합니다.<br/>
                      <span className="text-[10px]">(출처: 고용노동부 홈페이지 참조)</span>
                    </div>
                  </div>
                  <div className="flex justify-center mt-6">
                    <button
                ...
                <div className="relative bg-[#FFE6F2] rounded-3xl shadow-lg p-2 w-[360px] max-h-[60vh] overflow-y-auto border-4 border-pink-200">
                  <div className="flex flex-col items-center mb-1">
                    <div className="text-xl font-['Do_Hyeon'] text-pink-600 mb-3 flex items-center">
                      <span className="mr-2">💌</span> 전국 모성보호 신고센터 연락처
                    </div>
                  </div>
                  <table className="w-full text-xs font-['Do_Hyeon'] bg-white rounded-xl overflow-hidden">
                    <thead className="bg-pink-100 text-pink-700">
                      <tr>
                        ...
                        <th className="py-2 px-2 border-l-2 border-pink-200">연번</th>
                        <th className="py-2 px-2">관서명</th>
                        <th className="py-2 px-2">전화번호</th>
                      </tr>
                    </thead>
                    <tbody>
                      ...
                      {[
                        ...
                        [6, "서울북부", "02-950-9760", 31, "대구성", "053-667-6221"],
                        ...
                        <tr key={idx} className="even:bg-pink-50">
                          {row.map((cell, i) => (
                            <td
                              key={i}
                              className={`py-1 px-1 text-center border-b border-pink-100${i === 3 ? ' border-l-2 border-pink-200' : ''}`}
                            >
                              {cell || ''}
                            </td>
                          ))}
