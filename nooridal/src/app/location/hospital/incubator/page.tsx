...
export default function IncubatorPage() {
      ...
      nearbyClinics.forEach(clinic => {
        ...
        const content = `
          <div style="padding:10px; width: 250px; font-size: 12px; line-height: 1.4;">
            ...
            <div style="margin-top: 5px;">인큐베이터: <span style="font-weight: bold; color: #E53E3E;">${clinic.incubatorCount}</span>대</div>
  ...
  return (
    <div className="flex flex-col h-screen w-full max-w-md mx-auto bg-[#FFF4BB]">
      {/* Header */}
      ...
      {loading && (
         <div className="flex-grow flex items-center justify-center">
            <div className="text-center font-['Do_Hyeon'] text-gray-600">
              <div className="inline-block animate-spin rounded-full h-8 w-8 border-b-2 border-blue-500 mb-2"></div>
              <div>주변 병원 정보를 찾는 중입니다...</div>
            </div>
         </div>
      )}
          ...
          {nearbyClinics.length === 0 ? (
            ...
            <>
              ...
              {nearbyClinics.map(clinic => (
                <div key={clinic.id} className="bg-white p-3.5 rounded-xl shadow-sm border border-gray-200">
                  <div className="flex items-start">
                    ...
                    <div className="flex-1">
                      <div className="flex justify-between items-baseline">
                          <h3 className="text-md font-['Do_Hyeon'] text-red-700 mb-0.5">{clinic.name}</h3>
                          <span className="text-xs font-bold font-['Do_Hyeon'] text-gray-600">
                            {clinic.distance?.toFixed(1)}km
                          </span>
                      </div>
                      <p className="text-xs text-gray-500 font-['Do_Hyeon']">{clinic.type}</p>
                      <p className="text-xs text-gray-700 mt-1.5 font-['Do_Hyeon']">{clinic.address}</p>
